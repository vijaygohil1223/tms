(function() {
        ...
        for (var c = fa(a.e()), d = 0; d < c.length; d++) {
            ...
            if (null != b.c[f]) {
                ...
                if (e.da)
                    ...
                    e = w(b, f), g ? (g = w(a, f)) ? qa(g, e) : v(a, f, e.clone()) : v(a, f, e)
            }
        }
    }
    k.clone = function() {
    ...
    E.prototype.e = function() {
        F || (F = t(E, {0: {name: "PhoneMetadata", ja: "i18n.phonenumbers.PhoneMetadata"}, 1: {name: "general_desc", a: 11, type: C}, 2: {name: "fixed_line", a: 11, type: C}, 3: {name: "mobile", a: 11, type: C}, 4: {name: "toll_free", a: 11, type: C}, 5: {name: "premium_rate", a: 11, type: C}, 6: {name: "shared_cost", a: 11, type: C}, 7: {name: "personal_number", a: 11, type: C}, 8: {name: "voip", a: 11, type: C}, 21: {name: "pager", a: 11, type: C}, 25: {name: "uan", a: 11, type: C}, 27: {name: "emergency", a: 11, type: C}, 28: {name: "voicemail", a: 11, type: C}, 24: {name: "no_international_dialling",
                ...
                pa: !0, a: 11, type: z}, 20: {name: "intl_number_format", pa: !0, a: 11, type: z}, 22: {name: "main_country_for_code", a: 8, defaultValue: !1, type: Boolean}, 23: {name: "leading_digits", a: 9, type: String}, 26: {name: "leading_zero_possible", a: 8, defaultValue: !1, type: Boolean}}));
        return F
    };
    E.ctor = E;
    ...
    I.prototype.ca = function(a, b) {
        if (11 == a.p || 10 == a.p)
            return b instanceof r ? b : this.$(a.na.e(), b);
        if (14 == a.p || !a.ia)
            return b;
        var c = a.na;
        if (c === String) {
            if ("number" == typeof b)
                return String(b)
        } else if (c === Number && "string" == typeof b && ("Infinity" === b || "-Infinity" === b || "NaN" === b || /^-?[0-9]+$/.test(b)))
            return Number(b);
        return b
    };
    function J() {
    ...
    function Na(a, b) {
        ...
        for (var d, e = c.length, f = 1; 3 >= f && f <= e; ++f)
            if (d = parseInt(c.substring(0, f), 10), d in L)
    ...
    function Oa(a, b, c, d, e) {
        ...
        if (0 == g.length)
            ...
            g = g.replace(O, ""), a.clear(), a.append(Ga(g)), f = 1;
        else {
            g = new RegExp(f);
            Ha(a);
            f = a.toString();
            if (0 == f.search(g)) {
                var g = f.match(g)[0].length, h = f.substring(g).match(va);
        ...
        if (null != b && (f = b.l(), g = "" + f, h = a.toString(), 0 == h.lastIndexOf(g, 0))) {
            var l = new q(h.substring(g.length)), h = u(b, 1), g = new RegExp(x(h, 2));
            Pa(l, b, null);
            b = l.toString();
            h = x(h, 3);
            if (!P(g, a.toString()) && P(g, b) || 3 == Ma(h, a.toString()))
                return c.append(b), d && v(e, 6, 10), e.ba(f), f
        }
        e.ba(0);
        return 0
    }
    function Pa(a, b, c) {
        var d = a.toString(), e = d.length, f = u(b, 15);
        if (0 != e && null != f && 0 != f.length && (f = new RegExp("^(?:" + f + ")"), e = f.exec(d))) {
            ...
            } else if (d = d.replace(f, b), !h || P(g, d))
    ...
    function Qa(a, b, c, d) {
        ...
        var e = new q, f = b.indexOf(";phone-context=");
        if (0 < f) {
            var g = f + 15;
            if ("+" == b.charAt(g)) {
                var h = b.indexOf(";", g);
        ...
        if (!Fa(e.toString()))
            throw"The string supplied did not seem to be a phone number";
        f = e.toString();
        if (!(R(c) || null != f && 0 < f.length && O.test(f)))
            throw"Invalid country calling code";
        f = new G;
        d && v(f, 5, b);
        a:{
        ...
        try {
            ...
            if ("Invalid country calling code" == B && O.test(l)) {
                if (l = l.replace(O, ""), h = Oa(l, g, b, d, f), 0 == h)
                    throw B;
            } else
                throw B;
        }
    ...
    var Ta = new E;
    v(Ta, 11, "NA");
    var Ua = /\[([^\[\]])*\]/g, Va = /\d(?=[^,}][^,}])/g, Wa = RegExp("^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]*(\\$\\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]*)+$"), Xa = /[- ]/;
    function Sa(a, b) {
        var c = R(b) ? La(a.oa, b) : 0, c = V(a.oa, U(c));
        return null != c ? c : Ta
    }
    function Ya(a) {
    ...
    function Za(a, b) {
        for (var c = [], d = b.length - 3, e = a.h.length, f = 0; f < e; ++f) {
            ...
            if (0 == y(g, 3))
                ...
                var h = Math.min(d, y(g, 3) - 1), g = u(g, 3, h);
        ...
        if (!a.m) {
            if (!a.ka)
                if (bb(a)) {
                    if (cb(a))
                        return db(a)
                } else if (0 < a.o.length && (c = a.b.toString(), a.b.clear(), a.b.append(a.o), a.b.append(c), c = a.d.toString(), d = c.lastIndexOf(a.o), a.d.clear(), a.d.append(c.substring(0, d))), a.o != eb(a))
                    return a.d.append(" "), db(a);
            return a.k.toString()
        }
        switch (a.u.f.length) {
            case 0:
            ...
            case 3:
                if (bb(a))
                    ...
                    return a.o = eb(a), fb(a);
            default:
                if (a.aa)
                    return cb(a) && (a.aa = !1), a.d.toString() + a.b.toString();
                if (0 < a.h.length) {
                    c = gb(a, b);
                    d = hb(a);
                    if (0 < d.length)
    ...
    function hb(a) {
        for (var b = a.b.toString(), c = a.h.length, d = 0; d < c; ++d) {
            ...
            if ((new RegExp("^(?:" + f + ")$")).test(b))
                return a.ea = Xa.test(u(e, 4)), b = b.replace(new RegExp(f, "g"), u(e, 2)), Z(a, b)
        }
        return""
    }
    function Z(a, b) {
    ...
    function bb(a) {
        var b = a.u.toString(), c = new RegExp("^(?:\\+|" + u(a.i, 11) + ")"), c = b.match(c);
    ...
    function gb(a, b) {
        ...
        if (0 <= c.substring(a.t).search(a.fa)) {
            var d = c.search(a.fa), c = c.replace(a.fa, b);
            a.q.clear();
            a.q.append(c);
            a.t = d;
    ...
    n("intlTelInputUtils.formatNumber", function(a, b, c, d, e) {
        try {
            var f = a.replace(/\D/g, ""), g = new Ra(b);
            b = "";
            var h;
            "+" == a.substr(0, 1) && (f = "+" + f);
            ...
            if (c && !a.split(" ext. ")[1]) {
                ...
                if (isNaN(parseFloat(m.substr(m.length - 2, 1))))
    ...
    n("intlTelInputUtils.getNumberType", function(a, b) {
        try {
            var c = M.r(), d;
            var e = Y(c, a, b), f = Ka(c, e), g = T(c, e.l(), f);
            if (null == g)
                d = -1;
            else {
                var h = S(e);
    ...
    n("intlTelInputUtils.isValidNumber", function(a, b) {
        try {
            var c = M.r(), d = Y(c, a, b), e;
            var f = Ka(c, d), g = d.l(), h = T(c, g, f);
            if (null == h || "001" != f && g != La(c, f))
                e = !1;
            else {
                var l = S(d);
                e = -1 != W(l, h)
    ...
    n("intlTelInputUtils.numberType", {FIXED_LINE: 0, MOBILE: 1, FIXED_LINE_OR_MOBILE: 2, TOLL_FREE: 3, PREMIUM_RATE: 4, SHARED_COST: 5, VOIP: 6, PERSONAL_NUMBER: 7, PAGER: 8, UAN: 9, VOICEMAIL: 10, UNKNOWN: -1});
    n("intlTelInputUtils.validationError", {IS_POSSIBLE: 0, INVALID_COUNTRY_CODE: 1, TOO_SHORT: 2, TOO_LONG: 3, NOT_A_NUMBER: 4});
