        ...
        link: function (scope, elm, attrs, ctrl) {  
            elm.on('keydown', function (event) {  
                ...
                if (event.which == 64 || event.which == 16) {  
                    // numbers  
                    return false;  
                } if ([8, 9, 13, 27, 37, 38, 39, 40, 110, 189, 109].indexOf(event.which) > -1) {  
...
app.directive('select2Tabpermission', function($http, rest, $timeout) {
    return {
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            ...
            var tabs = { "due_today": 'Due Today', "assigned": 'Assign', "ongoing": 'Ongoing', "qa_ready": 'QA Ready', "qa_issue": 'QA Issue', "pm_ready": 'PM Ready', "delivery": 'Delivery', "completed": 'Completed', "overdue": 'Overdue', "due_tomorrow": 'Due Tomorrow', "my_project": 'My Project', "upcoming": 'Upcoming', "approved": 'Approved', "all": 'All' };
            var arr = [];
