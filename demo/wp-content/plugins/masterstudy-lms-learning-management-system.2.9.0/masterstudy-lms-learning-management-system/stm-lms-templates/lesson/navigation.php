...
if ( ! empty( $course_meta['curriculum'] ) ) :
	...
	if ( in_array( (string) $item_id, $curriculum, true ) ) {

		$current_lesson_id = array_search( (string) $item_id, $curriculum, true );
						...
						<span>
							<?php if ( ! empty( $prev_section['text'] ) ) : ?>
								<span class="stm_lms_section_text">
									<?php echo esc_html( sanitize_text_field( $prev_section['text'] ) ); ?>
								</span>
							<?php endif; ?>
							<span>
					...
					<a href="<?php echo esc_url( STM_LMS_Lesson::get_lesson_url( $post_id, $next_lesson ) ); ?>">
						<span>
							<?php if ( ! empty( $next_section['text'] ) ) : ?>
								<span class="stm_lms_section_text">
									<?php echo esc_html( sanitize_text_field( $next_section['text'] ) ); ?>
								</span>
							<?php endif; ?>
