...
class Plugin
{
    ...
    {
        $this->add_actions();
        add_action('elementor/editor/before_enqueue_styles', [$this, 'preview_styles']);
        add_action('elementor/frontend/after_enqueue_styles', [$this, 'preview_styles']);
    ...
    {
        wp_enqueue_style('stm_lms_icons', STM_LMS_URL . 'assets/icons/style.css', NULL);
