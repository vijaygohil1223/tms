    ...
    <div class="question_image__popup" v-bind:class="{'loading' : loading}">
		...
		<?php if (class_exists('STM_LMS_Media_library')) : ?>
			<div class="question_image__popup_actions">
				...
				<a href="#" class="button" @click.prevent="checkImage">
				...
				<a href="#" class="cancel" @click.prevent="$set(item, 'image_opened', false)">
					<?php esc_html_e('Close', 'masterstudy-lms-learning-management-system'); ?>
				</a>
				
				<a href="#" class="delete" v-if="hasImage()" @click.prevent="$set(item, 'image', {})">
