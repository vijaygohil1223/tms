...
class jobstatussearch {
	...
	//price1 data manage
		...
		public function searchExternalResource(){
			...
			$qry = "SELECT tu.vUserName AS resourceName, tu.freelancer As freelancerType, tu.address1Detail AS userCountry, tcpl.resource_id, tcpl.specialization, tcpl.price_currency, tcpl.price_language, tcpl.price_basis FROM `tms_users` as tu LEFT JOIN tms_customer_price_list as tcpl ON tcpl.resource_id = tu.iUserId where tu.iFkUserTypeId =2";	
